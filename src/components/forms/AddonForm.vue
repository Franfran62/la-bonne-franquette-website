...
<template>
  ...
  <v-form v-model="valid" validate-on="invalid-input" @submit.prevent="submitForm">
    <v-text-field v-model="name" label="Nom de l'extra" placeholder="Entrez le nom de l'extra" variant="outlined"
    ...
    <v-select label="Taux TVA" :items="Object.values(VATRate)" v-model="selectedVATRate" item-title="name"
      ...
      :rules="[v => !!v || 'Le taux de TVA est nécessaire']" rounded="xl" class="input-spacing" />
